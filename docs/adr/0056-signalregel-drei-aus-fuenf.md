# ADR 0056: Fünf Kriterien, drei müssen erfüllt sein — und Signal B ohne Gap-up-Klausel
...
**Fünf Kriterien; Kandidat ist, wer mindestens drei erfüllt.**
...
Durchlaufen während der Sitzung. Die Gegenrechnung ist die Schwelle — drei
statt zwei Kriterien —, und ein Gap-up bleibt ein Kursanstieg über den
gleitenden Durchschnitt. Der Fall B4 der Prüfvorlage kehrt sich damit um.

### 3. Die Schwelle steigt auf drei

`screening.required_signal_count` steht von 2 auf **3**. Bei fünf Kriterien
sind drei die Mehrheit; zwei wären bei fünf Kriterien deutlich schwächer als
zwei bei drei Kriterien und liefen der Absicht — schärfer trennen — zuwider.

Die Regel bleibt „mindestens": Vier und fünf erfüllte Kriterien
qualifizieren ebenso.
...
qualifizierende Minimum 6. Dazwischen linear. Das bleibt eine **Setzung** und
...
**Erwartete Wirkung auf die Kandidatenzahl.** Drei Effekte wirken
gegeneinander, und keiner davon ist vorab gemessen:

- Die Schwelle steigt (weniger Kandidaten),
- Signal B wird durchlässiger (mehr),
- E ist in ruhigen Märkten meist erfüllt und wirkt dann wie ein
  Freibetrag — faktisch verschiebt sich die Hürde auf „zwei Ereignissignale
  **und** kein frisches Gegensignal" (mehr),
- D feuert selten; ein RSI unter 30 ist die Ausnahme (weniger).
...
**Der Kombinationsraum des Backtests wächst von 4 auf 16.** Der Backtest
weist Kennzahlen je qualifizierender Signalkombination aus; bei „mindestens 3
von 5" sind das alle Teilmengen der Größe 3, 4 und 5. Je Aktie und Lauf
entstehen damit 48 statt 12 Ergebniszeilen. Die Folge ist keine technische,

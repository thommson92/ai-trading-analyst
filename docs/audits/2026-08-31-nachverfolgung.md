...
| A2-M4 | Backup/Restore minimal | **teilweise** | Sicherung und Zählprobe liegen jetzt als versionierte Skripte im Repository (`scripts/sicherung.ps1`, `scripts/sicherung-probe.ps1`) statt als abzutippende Schnipsel; Doc 14, Abschnitt „Sicherung“ führt Einrichtung, Aufgabe und Abnahme. Offen bleibt allein die **Ausführung am Server**: erster Lauf, Aufgabe eintragen, einmal die Zählprobe durchspielen |

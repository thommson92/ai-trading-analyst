...
**Stand:** 2026-09-01 (nach PR #60 und dem Folge-Zweig
`feature/audit-2-und-none-provider`: `none`-Provider, ADR 0049/0050,
Doc-14-Abschnitte Betriebszustand/Sicherung/Pflege, Doku-Nachzüge)
...
| A2-M10 | M14-Rest: `pushover`, Finnhub-Token in den Header | **offen** | Gelegenheit |
| A2-M11 | Dashboard-Sprint vorbereiten | **teilweise** | E8 entschieden ([ADR 0049](../adr/0049-dashboard-mvp-nur-lan.md)); API-Ausbau und Frontend sind Sprint 6 |
